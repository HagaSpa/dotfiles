...
-- biome -> mise. root_markers is what makes the format-on-save filter below fall
-- back to ts_ls outside biome projects.
...
vim.api.nvim_create_autocmd('BufWritePre', {
  ...
  callback = function(args)
    ...
    vim.lsp.buf.format({
      ...
      async = false,
      timeout_ms = 3000,
      -- biome registers formatting dynamically, so server_capabilities cannot test it.
